...
def set_particle_color(particle_list: list) -> None:
    total_particle = len(particle_list)
    mid_number = int(total_particle/2)
    for particle_id in range(0, mid_number):
        sim.particles[particle_id].color = "red"


set_particle_color(sim.particles)
